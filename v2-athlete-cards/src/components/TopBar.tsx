...
export default function TopBar() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-12" style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }}>
        {/* Left: Back + Logo */}
        <div className="flex items-center gap-6">
          ...
          <h1 className="text-xl font-bold shrink-0" style={{ fontFamily: 'var(--font-display)' }}>
        ...
        <div className="flex items-center gap-4">
          ...
          {activeTab !== 'athletes' && session && !compareMode && (
            <div className="flex items-center gap-2 text-xs">
              ...
              <span className="text-text-secondary truncate max-w-[180px]">{session.workoutName}</span>
            </div>
          )}
          {compareMode && (
